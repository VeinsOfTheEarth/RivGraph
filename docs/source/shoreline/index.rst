...
------------------------
There are numerous tools available to generate your shoreline, or you may automate a procedure. Here, we describe shoreline creation with QGIS, although other GIS software may also be used.
